export default function LoginWidget(){
    return (
        <>
        <div className="bg-gray-700 m-1 rounded-xl shadow-xl p-3 lg:w-1/4  md:w-1/2 sm:w-full xs: w-full mx-auto text-white">
                ...
                <div>
                    <label htmlFor="last_name" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white"></label>
